$(function () {
  ...
  QUnit.test('should activate element by tab id', function (assert) {
    ...
    $('<ul><li id="index"/><li id="profile"/></ul>').appendTo('#qunit-fixture')

    $(tabsHTML).find('li:last-child a').bootstrapTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'profile')

    $(tabsHTML).find('li:first-child a').bootstrapTab('show')
    assert.strictEqual($('#qunit-fixture').find('.active').attr('id'), 'index')
  })
  ...
  QUnit.test('should activate element by tab id in ordered list', function (assert) {
    ...
    $('<ol><li id="index"/><li id="profile"/></ol>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should activate element by tab id in nav list', function (assert) {
    ...
    $('<nav><div id="index"></div><div id="profile"></div></nav>').appendTo('#qunit-fixture')
  ...
  QUnit.test('should not fire shown when tab is already active', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a href="#index" class="nav-link active" role="tab">index</a></li>' +
      '<li class="nav-item"><a href="#profile" class="nav-link" role="tab">Profile</a></li>' +
      '</ul>' +
      '<div class="tab-content">' +
      '<div class="tab-pane active" id="index" role="tabpanel"></div>' +
  ...
  QUnit.test('selected tab should have aria-selected', function (assert) {
    ...
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li><a class="nav-item active" href="#index" toggle="tab" aria-selected="true">index</a></li>' +
  ...
  QUnit.test('selected tab should deactivate previous selected tab', function (assert) {
    assert.expect(2)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a class="nav-link active" href="#index" data-toggle="tab">index</a></li>' +
  ...
  QUnit.test('selected tab should deactivate previous selected link in dropdown', function (assert) {
    assert.expect(3)
    var tabsHTML = '<ul class="nav nav-tabs">' +
        '<li class="nav-item"><a class="nav-link" href="#index" data-toggle="tab">index</a></li>' +
        '<li class="nav-item"><a class="nav-link" href="#profile" data-toggle="tab">Profile</a></li>' +
  ...
  QUnit.test('should not remove fade class if no active pane is present', function (assert) {
    ...
    var done = assert.async()
    var tabsHTML = '<ul class="nav nav-tabs" role="tablist">' +
      '<li class="nav-item"><a id="tab-index" href="#index" class="nav-link" data-toggle="tab" role="tab">index</a></li>' +
      '<li class="nav-item"><a id="tab-profile" href="#profile" class="nav-link" data-toggle="tab" role="tab">Profile</a></li>' +
      '</ul>' +
      '<div class="tab-content">' +
      '<div class="tab-pane fade" id="index" role="tabpanel"></div>' +
      ...
      .on('shown.bs.tab', function () {
        ...
        $('#tab-index')
          .on('shown.bs.tab', function () {
            ...
            assert.ok($('#index').hasClass('fade'))
            assert.ok($('#index').hasClass('show'))
